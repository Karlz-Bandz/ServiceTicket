...
public class PdfGenerationServiceImpl implements PdfGenerationService {
    ...
    public void generatePdf(MasterTicketDto masterTicketDto) throws IOException, DocumentException {
        ...
        File file = new File(home + "\\Downloads\\test53.pdf");
        ...
        try {
            ...
            Paragraph paragraphTitle = new Paragraph("Formularz zgłoszenia awarii", fontTitle);
            ...
            addRow(table2, "Nazwisko i imię:", "Karol Bylak");
            addRow(table2, "Pełniona funkcja:", "Operator");
            addRow(table2, "Telefon", "555666333");

            PdfPTable table3 = new PdfPTable(2);
            table3.setWidthPercentage(90);
            table3.setSpacingAfter(20);
            table3.setSpacingBefore(20);
            addRow(table3, "Klient:", "Test");
            addRow(table3, "Identyfikator:", "BPSA12222");
            addRow(table3, "Numer seryjny:", "13-2222333");
            addRow(table3, "Typ urządzenia:", "BANKOMAT");
            addRow(table3, "Lokalizacja", "ul. kkkkaaa");
            addRow(table3, "Kontakt telefoniczny w miejscu awarii:", "44445555444");
